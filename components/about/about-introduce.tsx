...
export default async function Introduce() {
    return (
        <div>
            <h2 className="text-xl sm:text-5xl sm:font-normal mb-8">About Me</h2>
            <div className=" rounded-lg border p-8 text-content w-full  sm:mt-0 sm:rounded-3xl sm:border sm:p-11 text-white text-lg">
